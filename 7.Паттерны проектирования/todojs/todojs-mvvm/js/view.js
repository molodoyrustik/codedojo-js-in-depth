class View {
  ...
  add(data) {
    this.viewModel.add(data, message => this.message = message);
  }

  update(id, data) {
    this.viewModel.update(id, data, message => this.message = message);
  }

  remove(id) {
    this.viewModel.remove(id, message => this.message = message);
  }
}